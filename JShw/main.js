...
function search() {
    if ($searchBtn1.value.trim != '') {
        datetime();
    } else if ($searchBtn1.value.trim != '') {
        city();
    }
...
function datetime() {
    ...
    var filteritem = $searchBtn1.value.trim().toLowerCase();
    window.a = $searchBtn1.value.trim().toLowerCase();
...
function city() {
    // Format the user's search by removing leading and trailing whitespace, lowercase the string
    var filteritem = $searchBtn2.value.trim().toLowerCase();
